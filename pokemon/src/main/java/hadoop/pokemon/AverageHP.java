...
public class AverageHP {
	...
	public static class TokenizerMapper extends Mapper<Object, Text, Text, FloatWritable> {
		...
		public void map(Object key, Text value, Context context) throws IOException, InterruptedException {
			...
			try {
				Float hp = Float.parseFloat(values[5]);
	...
	public static void main(String[] args) throws Exception {
		...
		Job job = Job.getInstance(conf, "AverageHP");
		job.setJarByClass(AverageHP.class);
